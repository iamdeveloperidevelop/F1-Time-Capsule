...
2. Improve natural Polish, clarity, flow, and structure.
3. Preserve attribution, confidence, uncertainty, names, and diacritics.
...
duplication, preserved uncertainties, and any factual issues returned for
research rather than silently edited.
