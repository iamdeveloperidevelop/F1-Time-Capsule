<!-- Document metadata lives in the sibling teams.template.meta.yaml (schema: templates/shared/document-metadata.template.yaml). -->
...
[Identity: entrant name, owner/principal, key named staff, known sponsors/partners — or explicit uncertainty. Link fuller non-driver profiles to people-and-organisations.md.]

### Confirmed drivers and equipment
