...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | Alain Prost | Renault | 4 | 13 | — |
| 2 | Nelson Piquet | Brabham | 9 | 9 | — |
| 3 | Keke Rosberg | Williams | 6 | 8 | — |
| 4 | Carlos Reutemann | Williams | 0 | 6 | — |
| 5 | René Arnoux | Renault | 0 | 4 | remis punktów z Watsonem |
| 5 | John Watson | McLaren | 3 | 4 | remis punktów z Arnouxem |
| 7 | Niki Lauda | McLaren | 0 | 3 | — |
| 8 | Nigel Mansell | Lotus | 2 | 2 | — |
| 9 | Michele Alboreto | Tyrrell | 1 | 1 | — |

## Klasyfikacja konstruktorów

| Pozycja | Konstruktor | Punkty z tej rundy | Suma | Uwaga |
| ---: | --- | ---: | ---: | --- |
| 1 | Renault | 4 | 17 | Prost 4 (Arnoux 0 w tej rundzie) |
| 2 | Williams | 6 | 14 | Rosberg 6 (Reutemann 0) |
| 3 | Brabham | 9 | 9 | Piquet 9 |
| 4 | McLaren | 3 | 7 | Watson 3 (Lauda 0) |
| 5 | Lotus | 2 | 2 | Mansell 2 |
| 6 | Tyrrell | 1 | 1 | Alboreto 1 |

## Zasady zliczania

Druga runda punktowa sezonu (po pustej Argentynie). Skala przyjęta
...
3. Kolejność 1–6 na mecie: `MS-APR1982-BRA`, `AS-1982-BRA` (`R03-PO-TOP6-01`).
4. Luka oficjalnego wyniku: `1982-R03-PO-RES-01`. Poprzedni stan:
   [`../02-argentine-grand-prix/standings-after.md`](../02-argentine-grand-prix/standings-after.md).

## Uwagi źródłowe

Narracja wyścigu: [`post-race.md`](post-race.md). Rejestr:
